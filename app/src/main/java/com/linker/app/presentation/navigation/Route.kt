...
sealed interface Route {
     ...
     * [listType] : FollowListType enum name'i (FOLLOWERS | FOLLOWING | PENDING_REQUESTS | SENT_REQUESTS)
     */
    @Serializable data class FollowList(val userId: String, val listType: String) : Route
}
